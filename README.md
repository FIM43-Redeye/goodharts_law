...
├── intent.txt              # Background: Anthropic Fellows Program context
...
For background on this work's connection to AI safety research, see `intent.txt` (Anthropic Fellows Program context).
